        ...
        <div class="glass-card p-6 border-l-4 border-emerald-500">
            ...
            <div class="mt-4 pt-4 border-t border-slate-200/50 dark:border-slate-700/50">
                <div class="flex mb-2 items-center justify-between">
                    <span class="text-xs font-semibold inline-block text-emerald-500">Valid: {{ $stats['jurnal_valid'] }}</span>
                </div>
                <div class="overflow-hidden h-2 mb-4 text-xs flex rounded-full bg-slate-200 dark:bg-slate-700">
                    <div @style(['width: ' . ($stats['jurnal_total'] > 0 ? ($stats['jurnal_valid'] / $stats['jurnal_total'] * 100) : 0) . '%']) class="shadow-none flex flex-col text-center whitespace-nowrap text-slate-900 dark:text-white justify-center bg-emerald-500"></div>
                </div>
            </div>
        </div>
