<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="glass-card p-6 border-l-4 border-amber-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-slate-400 text-sm font-medium mb-1">Jurnal Menunggu Validasi</p>
        ...
        <div class="glass-card p-6 border-l-4 border-emerald-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-slate-400 text-sm font-medium mb-1">Total Jurnal Bimbingan</p>
                    <h3 class="text-2xl font-bold text-slate-100">{{ $stats['jurnal_masuk'] ?? 0 }}</h3>
                </div>
