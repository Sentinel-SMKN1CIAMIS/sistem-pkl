        ...
        <form action="{{ route('admin.logs.index') }}" method="GET" class="flex flex-col gap-4">
            <div class="grid grid-cols-1 md:grid-cols-5 gap-3">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="flex-1 px-6 py-2.5 bg-slate-850 dark:bg-slate-700 text-white font-bold rounded-xl hover:bg-slate-850 dark:hover:bg-slate-650 transition-all text-sm cursor-pointer shadow-md border border-transparent">
                        Filter
                    </button>
