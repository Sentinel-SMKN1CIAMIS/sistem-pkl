            ...
            <form action="{{ route('admin.kompetensi.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        <label for="konsentrasi_keahlian_id" class="block text-sm font-medium text-slate-300 mb-2">Pilih Jurusan / Konsentrasi</label>
                    ...
                    <div class="md:col-span-2">
                        <label for="nama" class="block text-sm font-medium text-slate-300 mb-2">Elemen Kompetensi / Capaian Pembelajaran</label>
                        <textarea name="nama" id="nama" rows="4" required
                                  class="w-full px-4 py-2.5 bg-slate-900/50 border border-slate-700/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-200 placeholder-slate-500 transition-all font-mono text-sm"
                                  placeholder="Contoh: Menjelaskan dasar-dasar pemrograman prosedural..."></textarea>
                    </div>

                    <div>
                        <label for="kategori" class="block text-sm font-medium text-slate-300 mb-2">Kategori (Opsional)</label>
