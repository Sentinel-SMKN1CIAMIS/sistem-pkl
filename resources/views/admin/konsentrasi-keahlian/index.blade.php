<x-app-layout>
    ...
    <div class="mb-6 flex justify-between items-center">
        <p class="text-slate-400">Daftar konsentrasi keahlian per program keahlian.</p>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="border-b border-slate-700/50 bg-slate-800/30">
                        <th class="px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Program Keahlian</th>
                        <th class="px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Kode</th>
                        <th class="px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Nama Konsentrasi</th>
                        <th class="px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Durasi</th>
                        ...
                        <tr class="hover:bg-slate-800/20 transition-colors group">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <a href="{{ route('admin.konsentrasi_keahlian.edit', $item) }}" class="p-2 text-slate-400 hover:text-blue-400 transition-colors" title="Edit">
