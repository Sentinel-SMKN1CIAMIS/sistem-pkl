<x-app-layout>
    ...
    <div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div>
            <a href="{{ route('pembimbing_dudi.feedback.create') }}" class="px-4 py-2 text-sm whitespace-nowrap bg-blue-600 hover:bg-blue-500 text-white font-medium rounded-xl shadow-lg shadow-blue-500/25 transition-all flex items-center justify-center gap-2">
