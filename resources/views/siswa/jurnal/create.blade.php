                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="foto" class="flex flex-col items-center justify-center w-full h-32 border-2 border-slate-200 dark:border-slate-700 border-dashed rounded-xl cursor-pointer bg-slate-100 dark:bg-slate-900/20 hover:bg-slate-100 dark:bg-slate-900/40 transition-all">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    <i data-lucide="camera" class="w-8 h-8 text-slate-500 dark:text-slate-400 mb-2"></i>
                                    <p class="text-xs text-slate-600 dark:text-slate-400">Klik untuk unggah foto (JPG, PNG, max 2MB)</p>
                                </div>
