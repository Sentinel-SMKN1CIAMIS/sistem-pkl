<x-app-layout>
    ...
    <div x-data="{ importPanelOpen: false, guideModalOpen: false }">
        <div class="mb-6 pokja-header-container">
            <div class="flex-1">
                <p class="text-slate-600 dark:text-slate-400 text-sm">Dunia Usaha & Dunia Industri (DUDI) per Konsentrasi Keahlian.</p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto shrink-0">
                ...
                <a href="{{ route('pokja.dudi.create') }}" class="pokja-btn px-4 py-2 text-sm whitespace-nowrap bg-blue-600 hover:bg-blue-500 text-white font-medium rounded-xl shadow-lg shadow-blue-500/25 transition-all gap-2">
        ...
        <div class="w-full mb-6" x-show="importPanelOpen" 
            ...
            <div class="glass-card w-full rounded-2xl overflow-hidden shadow-xl border border-slate-200/50 dark:border-slate-700/50 bg-white dark:bg-slate-900 p-6 space-y-4 text-left">
                ...
                <!-- Panel Body Form -->
                <form action="{{ route('pokja.dudi.import') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="p-4 bg-blue-500/5 border border-blue-500/10 rounded-xl flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] text-slate-600 dark:text-slate-400 mt-1 leading-relaxed">
                                    Unduh template standar agar struktur kolom data instansi terisi secara tepat.
                                </p>
                                <a href="{{ route('pokja.import.template', 'dudi') }}" class="inline-flex items-center gap-1.5 mt-2.5 text-[11px] font-bold text-blue-500 hover:text-blue-400 transition-colors bg-blue-500/10 px-3 py-1.5 rounded-lg border border-blue-500/20">
                        ...
                        <div class="p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-xl flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] text-slate-600 dark:text-slate-400 mt-1 leading-relaxed">
                                    Lihat panduan penulisan kolom, format multi-jurusan, dan daftar nama jurusan resmi di database.
                                </p>
                      ...
                      <div class="p-6 overflow-y-auto space-y-6 text-sm text-slate-600 dark:text-slate-400">
                          ...
                          <div class="space-y-3">
                              <h4 class="text-xs font-bold text-slate-900 dark:text-slate-100 uppercase tracking-wider flex items-center gap-1.5">
                                  ...
                                  Struktur Kolom data DUDI (Dunia Kerja / Industri):
                              </h4>
                              <div class="overflow-x-auto rounded-xl border border-slate-200/50 dark:border-slate-700/50">
                                  <table class="w-full text-xs text-left">
                                      ...
                                      <tbody class="divide-y divide-slate-200/30 dark:divide-slate-700/30">
                                          <tr>
                                              <td class="px-4 py-2.5 font-semibold text-slate-900 dark:text-slate-100">nama</td>
                                              <td class="px-4 py-2.5"><strong>Wajib.</strong> Nama resmi perusahaan/DUDI. Harus unik di database.</td>
                                              <td class="px-4 py-2.5 text-right font-mono text-blue-500">PT Solusi Digital</td>
                                          </tr>
                                          <tr>
                                              <td class="px-4 py-2.5 font-semibold text-slate-900 dark:text-slate-100">bidang_usaha</td>
                                              <td class="px-4 py-2.5">Opsional. Bidang komersial atau usaha DUDI.</td>
                                              <td class="px-4 py-2.5 text-right font-mono text-blue-500">Teknologi Informasi</td>
                                          </tr>
                                          <tr>
                                              <td class="px-4 py-2.5 font-semibold text-slate-900 dark:text-slate-100">alamat</td>
                                              <td class="px-4 py-2.5"><strong>Wajib.</strong> Alamat lengkap jalan lokasi perusahaan.</td>
                                              <td class="px-4 py-2.5 text-right font-mono text-blue-500">Jl. Asia Afrika No. 45</td>
                                          </tr>
                                          <tr>
                                              <td class="px-4 py-2.5 font-semibold text-slate-900 dark:text-slate-100">kota</td>
                                              <td class="px-4 py-2.5"><strong>Wajib.</strong> Kota/Kabupaten domisili perusahaan.</td>
                                              <td class="px-4 py-2.5 text-right font-mono text-blue-500">Bandung</td>
                                          </tr>
                                          <tr>
                                              <td class="px-4 py-2.5 font-semibold text-slate-900 dark:text-slate-100">konsentrasi_keahlian</td>
                                              <td class="px-4 py-2.5"><strong>Wajib.</strong> Nama jurusan yang diterima. Jika DUDI menerima multi-jurusan, gabungkan dan pisahkan dengan tanda koma (`,`) di dalam sel Excel bersangkutan.</td>
                                              <td class="px-4 py-2.5 text-right font-mono text-blue-500">Rekayasa Perangkat Lunak, Teknik Komputer Jaringan</td>
                                          </tr>
                                      </tbody>
                                  </table>
                              </div>
