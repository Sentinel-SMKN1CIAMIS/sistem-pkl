<x-app-layout>
    ...
    <div class="max-w-4xl text-slate-300">
        <div class="glass-card p-8 text-slate-300">
            <form action="{{ route('pokja.dudi.update', $dudi) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-slate-300">
                    ...
                    <div class="md:col-span-2">
                        <label for="nama" class="block text-sm font-medium text-slate-300 mb-2">Nama Perusahaan</label>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat" id="alamat" rows="3" required
                                  class="w-full px-4 py-2.5 bg-slate-900/50 border border-slate-700/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-200 transition-all">{{ old('alamat', $dudi->alamat) }}</textarea>
                        @error('alamat')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label for="no_telepon" class="block text-sm font-medium text-slate-300 mb-2">No. Telepon</label>
