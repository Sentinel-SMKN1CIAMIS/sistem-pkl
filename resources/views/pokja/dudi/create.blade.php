<x-app-layout>
    ...
    <div class="mb-6">
        <a href="{{ route('pokja.dudi.index') }}" class="flex items-center gap-2 text-sm text-slate-400 hover:text-slate-200 transition-colors inline-flex">
            ...
            <form action="{{ route('pokja.dudi.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        <label for="konsentrasi_keahlian_id" class="block text-sm font-medium text-slate-300 mb-2">Ditujukan untuk Jurusan</label>
                    ...
                    <div class="md:col-span-2">
                        <label for="nama" class="block text-sm font-medium text-slate-300 mb-2">Nama DUDI / Perusahaan</label>
                    ...
                    <div>
                        <label for="kota" class="block text-sm font-medium text-slate-300 mb-2">Kota / Kabupaten</label>
                    ...
                    <div>
                        <label for="no_telepon" class="block text-sm font-medium text-slate-300 mb-2">No. Telepon / WA Perusahaan</label>
                    ...
                    <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                         <div>
                            <label for="nama_pimpinan" class="block text-sm font-medium text-slate-300 mb-2">Nama Pimpinan / HRD</label>
                            <input type="text" name="nama_pimpinan" id="nama_pimpinan" value="{{ old('nama_pimpinan') }}"
                                   class="w-full px-4 py-2.5 bg-slate-900/50 border border-slate-700/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-200 transition-all"
                                   placeholder="Nama pimpinan">
                        </div>
                        <div>
                            <label for="bidang_usaha" class="block text-sm font-medium text-slate-300 mb-2">Bidang Usaha</label>
