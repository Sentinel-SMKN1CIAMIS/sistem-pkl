            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="glass-card p-6 md:col-span-1">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="jabatan" class="block text-sm font-medium text-slate-300 mb-2">Jabatan di Perusahaan</label>
                ...
                <div class="glass-card p-6 md:col-span-2">
                    ...
                    <div>
                        <label for="dudi_id" class="block text-sm font-medium text-slate-300 mb-2">Bekerja di Industri</label>
                        ...
                        <p class="mt-2 text-xs text-slate-500 italic">Mentor hanya dapat melihat & memvalidasi siswa yang PKL di perusahaan yang sama.</p>
                    </div>
                </div>
            </div>
