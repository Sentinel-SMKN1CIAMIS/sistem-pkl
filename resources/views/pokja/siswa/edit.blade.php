                ...
                <div class="glass-card p-6 md:col-span-1 space-y-6">
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="pembimbing_sekolah_id" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Guru Pembimbing Kejuruan</label>
                                <select name="pembimbing_sekolah_id" id="pembimbing_sekolah_id"
                                        class="w-full px-4 py-2.5 bg-slate-100 dark:bg-slate-900/50 border border-slate-200/50 dark:border-slate-700/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-800 dark:text-slate-200 transition-all">
                                    <option value="">-- Pilih Pembimbing Kejuruan --</option>
                                    @foreach($pembimbingSekolah->whereIn('tipe', ['kejuruan', 'keduanya']) as $item)
                            ...
                            <div>
                                <label for="pembimbing_sekolah_umum_id" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Guru Pembimbing Umum</label>
                                <select name="pembimbing_sekolah_umum_id" id="pembimbing_sekolah_umum_id"
                                        class="w-full px-4 py-2.5 bg-slate-100 dark:bg-slate-900/50 border border-slate-200/50 dark:border-slate-700/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-800 dark:text-slate-200 transition-all">
                                    <option value="">-- Pilih Pembimbing Umum --</option>
                                    @foreach($pembimbingSekolah->whereIn('tipe', ['umum', 'keduanya']) as $item)
                                        <option value="{{ $item->id }}" {{ old('pembimbing_sekolah_umum_id', $siswa->pembimbing_sekolah_umum_id) == $item->id ? 'selected' : '' }}>{{ $item->nama_lengkap }}</option>
                                    @endforeach
                                </select>
                            </div>
