<x-app-layout>
    ...
    <div class="mb-6">
        <a href="{{ route('pokja.siswa.index') }}" class="flex items-center gap-2 text-sm text-slate-400 hover:text-slate-200 transition-colors inline-flex">
            <i data-lucide="arrow-left" class="w-4 h-4"></i>
            Kembali ke Daftar
        </a>
    </div>

    <div class="max-w-5xl text-slate-300">
        <form action="{{ route('pokja.siswa.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="glass-card p-6 md:col-span-1">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="nis" class="block text-sm font-medium text-slate-300 mb-2">NIS (Username)</label>
                ...
                <div class="glass-card p-6 md:col-span-1">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="kelas" class="block text-sm font-medium text-slate-300 mb-2">Kelas</label>
                                <input type="text" name="kelas" id="kelas" value="{{ old('kelas') }}" required
                                       class="w-full px-4 py-2.5 bg-slate-900/50 border border-slate-700/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-200 transition-all" placeholder="Contoh: XII RPL 1">
                            </div>
                            <div>
                        ...
                        <div>
                            <label for="tahun_ajaran" class="block text-sm font-medium text-slate-300 mb-2">Tahun Ajaran</label>
                ...
                <div class="glass-card p-6 md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="dudi_id" class="block text-sm font-medium text-slate-300 mb-2">DUDI / Industri</label>
                        ...
                        <div>
                            <label for="pembimbing_sekolah_id" class="block text-sm font-medium text-slate-300 mb-2">Pembimbing Sekolah</label>
                        ...
                        <div>
                            <label for="pembimbing_dudi_id" class="block text-sm font-medium text-slate-300 mb-2">Pembimbing DUDI</label>
