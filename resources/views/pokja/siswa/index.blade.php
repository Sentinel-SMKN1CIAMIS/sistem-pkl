        ...
        <template x-teleport="body">
            <div x-show="importModalOpen" 
                ...
                <div @click.away="importModalOpen = false" 
                    ...
                    <!-- Modal Body -->
                    <form action="{{ route('pokja.siswa.import') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-4">
                        @csrf
                        ...
                        <div class="p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <a href="{{ route('pokja.import.template', 'siswa') }}" class="inline-flex items-center gap-2 mt-3 text-xs font-bold text-blue-500 hover:text-blue-400 transition-colors bg-blue-500/10 px-3 py-1.5 rounded-lg border border-blue-500/30">
                        ...
                        <div class="p-3.5 bg-slate-50 dark:bg-slate-800/20 border border-slate-200/50 dark:border-slate-700/50 rounded-xl">
                            ...
                            <ul class="list-disc pl-5 space-y-1 text-[11px] text-slate-600 dark:text-slate-400 leading-normal">
                                ...
                                <li>Gunakan kolom <strong>jenis_kelamin</strong> dengan huruf <strong>L</strong> atau <strong>P</strong>.</li>
                                <li><strong>Email</strong> dan <strong>NIS (sebagai username)</strong> harus unik di sistem.</li>
                                <li>Sistem menggunakan pengaman transaksi (jika ada 1 baris salah, seluruh proses akan dibatalkan/rollback demi integritas data).</li>
                            </ul>
                        </div>
