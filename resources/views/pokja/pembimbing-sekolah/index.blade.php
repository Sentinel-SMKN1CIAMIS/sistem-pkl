<x-app-layout>
    ...
    <div class="mb-6 flex justify-between items-center">
        <p class="text-slate-400">Daftar guru pembimbing sekolah per jurusan.</p>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="border-b border-slate-700/50 bg-slate-800/30">
                        <th class="px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Nama Lengkap</th>
                        <th class="px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">NIP / Username</th>
                ...
                <tbody class="divide-y divide-slate-700/50">
                    @forelse($teachers as $item)
                        <tr class="hover:bg-slate-800/20 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm text-slate-300 block font-mono">{{ $item->nip ?? '-' }}</span>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <a href="{{ route('pokja.pembimbing_sekolah.edit', $item) }}" class="p-2 text-slate-400 hover:text-blue-400 transition-colors" title="Edit">
