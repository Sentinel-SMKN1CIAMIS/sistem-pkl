        ...
        <form action="{{ route('pokja.pembimbing_sekolah.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="glass-card p-6 md:col-span-1">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="nama_lengkap" class="block text-sm font-medium text-slate-300 mb-2">Nama Lengkap (Gelar)</label>
                            <input type="text" name="nama_lengkap" id="nama_lengkap" value="{{ old('nama_lengkap') }}" required
                                   class="w-full px-4 py-2.5 bg-slate-900/50 border border-slate-700/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-200 transition-all">
                        </div>
                        <div>
                            <label for="nip" class="block text-sm font-medium text-slate-300 mb-2">NIP (Opsional)</label>
                ...
                <div class="glass-card p-6 md:col-span-2">
                    ...
                    <div>
                        <label for="konsentrasi_keahlian_id" class="block text-sm font-medium text-slate-300 mb-2">Tugas di Jurusan / Konsentrasi</label>
                        ...
                        <p class="mt-2 text-xs text-slate-500 italic">Pembimbing akan mengelola siswa dari jurusan yang dipilih.</p>
                    </div>
                </div>
            </div>
