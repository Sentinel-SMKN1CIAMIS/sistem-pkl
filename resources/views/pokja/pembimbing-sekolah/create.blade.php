        ...
        <form action="{{ route('pokja.pembimbing_sekolah.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="glass-card p-6 md:col-span-2">
                    ...
                    <div>
                        <label for="konsentrasi_keahlian_id" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Tugas di Jurusan / Konsentrasi</label>
                        ...
                        <p class="mt-2 text-xs text-slate-500 dark:text-slate-400 italic">Pembimbing akan mengelola siswa dari jurusan yang dipilih.</p>
                    </div>
                </div>
            </div>
